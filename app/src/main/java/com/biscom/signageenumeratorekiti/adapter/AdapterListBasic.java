package com.biscom.signageenumeratorekiti.adapter;
...
public class AdapterListBasic extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<EnforcementReport> items = new ArrayList<>();

    private Context ctx;
    private OnItemClickListener mOnItemClickListener;

    public interface OnItemClickListener {
        void onItemClick(View view, EnforcementReport obj, int position);
    }
    ...
    public AdapterListBasic(Context context, List<EnforcementReport> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            EnforcementReport p = items.get(position);
            view.name.setText(p.BusinessName);
            view.desc.setText(p.ManifestStatus);
